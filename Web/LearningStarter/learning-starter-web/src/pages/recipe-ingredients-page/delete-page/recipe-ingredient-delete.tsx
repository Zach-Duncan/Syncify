...
export const RecipeIngredientsDeletePage = () => {
  ...
  const onSubmit = async () => {
    const response = await axios.delete<ApiResponse<RecipeIngredientGetDto>>(
